...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String CREATE_WORD_TABLE=
            "CREATE TABLE "+ TABLE_WORDS + " ( " +
                    ...
                    Word.USERWORD+ " INTEGER DEFUALT 0)";
    ...
    public boolean addWord(String word, String def, int fav, String lang, int lookup, int userWord) {
        ...
        if(data.getCount() == 0) {
            ...
            values.put(Word.FAVORITE, fav);
            values.put(Word.LANGUAGE, lang);
            values.put(Word.LOOKUP, lookup);
...
//  Get words generated by the User.
    public ArrayList<String> searchUserWords(String condition) {
        String query="SELECT * FROM "+TABLE_USERWORDS+"";
        SQLiteDatabase db=getWritableDatabase();
        ArrayList<String> list=new ArrayList<String>();
